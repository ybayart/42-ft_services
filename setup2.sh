...
screen -dmS t1 sudo kubectl port-forward service/nginx 6022:22
screen -dmS t2 sudo kubectl port-forward service/wordpress 5050
screen -dmS t3 sudo kubectl port-forward service/phpmyadmin 5000
screen -dmS t4 sudo kubectl port-forward service/grafana 3000
